...
class main_listener implements EventSubscriberInterface
{
	...
	public function __construct(\phpbb\user $user, \phpbb\auth\auth $auth, \phpbb\config\config $config, \phpbb\template\template $template, \phpbb\controller\helper $helper, $memberlist, $apikey)	{
		$this->user = $user;
		$this->auth = $auth;
		$this->config = $config;
	...
	public function process_wowsstats($wws_id) {
		$this->template->assign_vars(array(
			...
			'WWS_ID'			=> $wws_id,));
		$ch = curl_init();
		$apiuri = 'https://api.worldofwarships.com/wows/account/info/?application_id='.$apikey.'&account_id='.$wws_id.'&language=en';
